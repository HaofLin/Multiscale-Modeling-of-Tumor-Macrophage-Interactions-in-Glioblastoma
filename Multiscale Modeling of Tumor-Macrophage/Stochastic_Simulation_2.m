...
% load(['D:\Matlab代码存放\2018胶质瘤\敏感性分析\5_15\CSF1RI_一段时间后IGFRI\' ...
%     'canshucanshu2yue24xin4_yongdrug_CSFRI_1_IGF1RI4_0.07_200day.mat'],'Survival_Rate','C5','C3','C','bm4');  
% ST3=[0 0 0 0 0 0 11];%data
% PST3=C5(1:7,1);
% figure,plot([0:20:120],ST3,'b o-- ','Linewidth',2.5,'MarkeredgeColor','b','MarkerfaceColor','b');axis([0,120,0,100])
% hold on, plot([0:20:120],PST3,'r o-- ','Linewidth',2.5,'MarkeredgeColor','r','MarkerfaceColor','r');axis([0,120,0,100])
...
%
load('nodrug_CSFRI_1_400day_lianxu_111.mat','Survival_Rate','C5','C3','C','bm4');  
ST1=[0 66 34 0 0 0 0 0];%data
PST1=C5(1:8,1);
figure,plot([0:20:140],ST1,'b o-- ','Linewidth',2.5,'MarkeredgeColor','b','MarkerfaceColor','b');axis([0,140,0,100])
hold on, plot([0:20:140],PST1,'r o-- ','Linewidth',2.5,'MarkeredgeColor','r','MarkerfaceColor','r');axis([0,140,0,100])
...
set(findobj('FontSize',18),'FontSize',figure_FontSize);
% 
load('yongdrug_CSFRI_1_400day_lianxu_111.mat','Survival_Rate','C5','C3','C','bm4');  
...
load('CSFRI_1_400day_CSF1RI_lianxu_EGFRI_400_111.mat','Survival_Rate','C5');  
...
load('CSFRI_1_400day_CSFRI_1_EGFRI_1_400day_zishiying_total_111.mat','Survival_Rate','C5');  
...
load('CSFRI_1_400day_CSF1RI_lianxu_IGF1RI_400_111.mat','Survival_Rate','C5');  
...
load('CSFRI_1_400day_CSFRI_1_IGF1RI_1_400day_zishiying_total_111.mat','Survival_Rate','C5');  
